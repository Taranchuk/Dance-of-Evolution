...
{
    [HarmonyPatch(typeof(HediffComp_GiveHediffLungRot), "CompPostTickInterval")]
	public static class HediffComp_GiveHediffLungRot_CompPostTickInterval_Transpiler
	{
		static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions)
		{
			...
			var interceptAnyGasMethod = AccessTools.Method(typeof(HediffComp_GiveHediffLungRot_CompPostTickInterval_Transpiler), "InterceptAnyGas");

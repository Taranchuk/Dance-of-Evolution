...
namespace DanceOfEvolution
{
    ...
    public static class Pawn_GetGizmos_Patch
    {
        ...
        {
            if (__instance.Faction == Faction.OfPlayer && __instance.IsServant())
            {
            ...
            {
                if (__instance.IsServant() && g is Command_Toggle command && command.defaultDesc == "CommandToggleDraftDesc".Translate())
                {
                    continue;
                }
                yield return g;

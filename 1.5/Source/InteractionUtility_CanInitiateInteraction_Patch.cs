...
{
	[HarmonyPatch]
	public static class InteractionUtility_CanReceiveInteraction_Patch
	{
		...
		{
			yield return AccessTools.Method(typeof(InteractionUtility), nameof(InteractionUtility.CanReceiveInteraction));
			yield return AccessTools.Method(typeof(InteractionUtility), nameof(InteractionUtility.CanInitiateInteraction));
		}
		...
		public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions)
		{
			...
			var modifyIsMutantResultMethod = AccessTools.Method(typeof(InteractionUtility_CanReceiveInteraction_Patch), nameof(ModifyIsMutantResult));
